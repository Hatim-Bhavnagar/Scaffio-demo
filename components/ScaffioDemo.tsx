  ...
  const renderScreen = () => {
    ...
    switch (screen) {
      ...
      case "Overview": return (
        <div>
          <SectionTitle eyebrow="Client demo" title="Scaffio MVP Web Application"
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16, marginBottom: 20 }}>
            {[["🧭","Diagnose the real gap","Scaffio analyses answer accuracy, explanation quality, confidence and misconception patterns — not just scores."],["🧱","Capture reasoning","Students select and sequence Logic Bricks, making their mathematical thinking visible and AI-reviewable."],["🤖","Coach Socratically","Live Claude AI asks guided questions using Scaffio's curriculum, misconception framework and RAG knowledge base."]].map(([icon,title,desc]) => (
